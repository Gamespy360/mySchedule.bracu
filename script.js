...
// Save changes on blur (when cell loses focus)
// document.querySelectorAll('[contenteditable]').forEach(function(cell) {
//   cell.addEventListener('blur', function() {
//     localStorage.setItem('cell-content-' + cell.id, cell.innerHTML);
//   });
// });
...
//   document.querySelectorAll('[contenteditable]').forEach(function(cell) {
//     const saved = localStorage.getItem('cell-content-' + cell.id);
//     if (saved !== null) {
